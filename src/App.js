...
import { Calculator, TrendingUp, FileText, Info, Wallet, Receipt, PiggyBank, Home as HomeIcon, Heart, Shield, Building2, Users, Briefcase, AlertTriangle, CreditCard, Banknote, Coins, Printer, LogIn, LogOut, User, Settings, Bell, Lock, RefreshCw, BookOpen, Percent, Mail, Gift, HelpCircle, Save, Repeat } from 'lucide-react';
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <div className="relative">
            <TabsList className="grid w-full grid-cols-9 md:grid-cols-9 h-auto mobile-tabs overflow-x-auto nav-scroll bg-transparent rounded-none p-0">
              ...
              <TabsTrigger 
                value="calculator" 
                className="flex-1 md:flex-none px-6 py-4 font-medium rounded-lg transition-all duration-200 flex flex-col items-center justify-center space-y-2 shadow-sm hover:shadow-md data-[state=active]:shadow-md relative"
                style={{
                  backgroundColor: activeTab === 'calculator' ? '#004D40' : '#f9fafb',
              ...
              <TabsTrigger 
                ...
                className="flex-1 md:flex-none px-6 py-4 font-medium rounded-lg transition-all duration-200 flex flex-col items-center justify-center space-y-2 shadow-sm hover:shadow-md data-[state=active]:shadow-md relative"
                style={{
                  backgroundColor: activeTab === 'cgt' ? '#04505c' : '#f9fafb',
                  color: activeTab === 'cgt' ? 'white' : '#374151',
              ...
              <TabsTrigger 
                ...
                className="flex-1 md:flex-none px-6 py-4 font-medium rounded-lg transition-all duration-200 flex flex-col items-center justify-center space-y-2 shadow-sm hover:shadow-md data-[state=active]:shadow-md relative"
                style={{
                  backgroundColor: activeTab === 'cit' ? '#402852' : '#f9fafb',
                  color: activeTab === 'cit' ? 'white' : '#374151',
              ...
              <TabsTrigger 
                ...
                className="flex-1 md:flex-none px-6 py-4 font-medium rounded-lg transition-all duration-200 flex flex-col items-center justify-center space-y-2 shadow-sm hover:shadow-md data-[state=active]:shadow-md relative"
                style={{
                  backgroundColor: activeTab === 'vat' ? '#1e6e48' : '#f9fafb',
                  color: activeTab === 'vat' ? 'white' : '#374151',
              ...
              <TabsTrigger 
                ...
                className="flex-1 md:flex-none px-6 py-4 font-medium rounded-lg transition-all duration-200 flex flex-col items-center justify-center space-y-2 shadow-sm hover:shadow-md data-[state=active]:shadow-md relative"
                style={{
                  backgroundColor: activeTab === 'payment' ? '#0e1c41' : '#f9fafb',
          ...
          <TabsContent value="calculator" className="space-y-6">
            ...
            {payeMode === 'single' && (
              ...
              {/* Input Form */}
              <Card className="bg-white shadow-lg" style={{ borderColor: '#004D4020' }}>
                <CardHeader className="text-white rounded-t-lg" style={{ background: 'linear-gradient(to right, #004D40, #005849)' }}>
