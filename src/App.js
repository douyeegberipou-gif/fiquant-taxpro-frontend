...
import { Calculator, TrendingUp, FileText, Info, Wallet, Receipt, PiggyBank, Home as HomeIcon, Heart, Shield, Building2, Users, Briefcase, AlertTriangle, CreditCard, Banknote, Coins, Printer, LogIn, LogOut, User, Settings, Bell } from 'lucide-react';
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          <div className="relative">
            <TabsList className="grid w-full grid-cols-9 md:grid-cols-9 h-auto mobile-tabs overflow-x-auto bg-transparent rounded-none p-0">
              ...
              <TabsTrigger 
                value="compliance" 
                disabled={!hasFeature('compliance_assistance')}
                className={`flex-1 md:flex-none px-6 py-4 text-gray-700 font-medium rounded-lg transition-all duration-200 flex flex-col items-center justify-center space-y-2 shadow-sm relative ${
                ...
                onClick={!hasFeature('compliance_assistance') ? (e) => {
                  e.preventDefault();
                  setAuthModalOpen(true);
                } : undefined}
              >
