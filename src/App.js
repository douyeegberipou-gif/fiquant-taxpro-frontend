...
function AppContent() {
  ...
  useEffect(() => {
    if (['calculator', 'cgt', 'cit', 'vat', 'deferred-tax', 'payment-processing'].includes(activeTab)) {
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="calculator" className="space-y-6">
            ...
            {payeMode === 'single' && (
              ...
              {result && (
                <Card className="bg-white shadow-lg flex-1 flex flex-col" style={{ borderColor: '#0A3D3D20' }}>
                  <CardHeader className="rounded-t-lg" style={{ background: 'linear-gradient(to right, #0A3D3D, #0D4D4D)', color: '#D4AF37' }}>
        ...
        >
          ...
          >
            ...
            <div className="bg-[#3D3D3D] px-6 pt-8 pb-6 text-center">
              ...
              <p className="text-gray-400 text-sm">Your data has been imported successfully</p>
            </div>
