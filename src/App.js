...
import { Calculator, TrendingUp, FileText, Info, Wallet, Receipt, PiggyBank, Home as HomeIcon, Heart, Shield, Building2, Users, Briefcase, AlertTriangle, CreditCard, Banknote, Coins, Printer, LogIn, LogOut, User, Settings, Bell, Lock, RefreshCw, BookOpen, Percent, Mail } from 'lucide-react';
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
              ...
              <div className="max-w-2xl mx-auto py-16 px-4 text-center">
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-6">
                  <p className="text-sm text-blue-800">
                    <strong>Pro Feature:</strong> Upgrade to Pro or higher to unlock calculation history and keep track of all your past tax computations.
                  </p>
                </div>
                <Button 
              ...
              <div className="max-w-2xl mx-auto py-16 px-4 text-center">
                ...
                <div className="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-6">
                  <p className="text-sm text-amber-800">
                    <strong>Premium Feature:</strong> Advanced Analytics is available exclusively for Premium tier subscribers.
                  </p>
                </div>
                <Button 
                  onClick={() => setActiveTab('calculator')}
          ...
          <TabsContent value="vat">
            <div className="space-y-6">
              ...
              {vatMode === 'single' && (
                <VATCalculator formatCurrency={formatCurrency} hasFeature={hasFeature} isAuthenticated={isAuthenticated} />
              )}
          ...
          <TabsContent value="cgt">
            <CGTCalculator formatCurrency={formatCurrency} hasFeature={hasFeature} isAuthenticated={isAuthenticated} />
          </TabsContent>
        </Tabs>
      </div>
