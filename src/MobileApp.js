    ...
    switch (activeTab) {
      ...
      case 'tax-info':
        return (
          <MobilePageWrapper>
            <div className="space-y-4">
              <h3 className="text-lg font-bold text-white mb-4">Nigerian Tax Information (NTA 2025)</h3>
              
              <InfoCard
                title="PAYE (Pay As You Earn)"
                description="Personal income tax deducted from employee salaries. Graduated rates from 7% to 24% based on income brackets. Includes reliefs like CRA (Consolidated Relief Allowance), pension, NHF, and NHIS."
              />
              <InfoCard
                title="CIT (Company Income Tax)"
                description="Tax on company profits. Small companies (turnover ≤₦25M) pay 0%, Large companies (turnover >₦100M) pay 30%. Includes capital allowances, loss relief, and investment allowances."
              />
              <InfoCard
                title="VAT (Value Added Tax)"
                description="7.5% tax on goods and services (NTA 2025). Some items are exempt or zero-rated including exports, medical services, and basic food items."
              />
              <InfoCard
                title="CGT (Capital Gains Tax)"
                description="10% tax on gains from disposal of chargeable assets. Individuals exempt if proceeds ≤₦2M and gains ≤₦500K. Companies pay flat 30%."
              />
              <InfoCard
                title="Tax Reliefs & Allowances"
                description="Personal reliefs: CRA (₦200K + 20% of gross), Pension (8%), NHF (2.5%), Mortgage Interest, Life Insurance, NHIS. Corporate: Capital allowances, Loss relief (up to 4 years), Investment allowance."
              />
              <InfoCard
                title="Filing Deadlines"
                description="PAYE: Monthly by 10th. VAT: Monthly by 21st. CIT: Within 6 months of year-end. Annual Returns: By January 31st following the tax year."
              />
            </div>
          </MobilePageWrapper>
        );
