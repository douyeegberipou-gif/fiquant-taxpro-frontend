    ...
    <div className="space-y-6">
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <Card className="bg-white border-green-100 shadow-lg">
          <CardHeader className="text-white" style={{ background: 'linear-gradient(to right, #04505c, #035a68)' }}>
        ...
        {((activeModule === 'crypto' && cryptoResult) || 
          ...
          <Card className="bg-white border-green-100 shadow-lg">
            <CardHeader className={`text-white`}
              style={{ 
                background: activeModule === 'crypto' ? 'linear-gradient(to right, #04505c, #035a68)' :
                  activeModule === 'shares' ? 'linear-gradient(to right, #04505c, #035a68)' :
                  'linear-gradient(to right, #04505c, #035a68)'
              }}
            >
              <CardTitle className="flex items-center space-x-2">
