...
import { Calculator, TrendingUp, AlertTriangle, Building, Coins, TrendingDown, Bitcoin, LineChart, Home, HelpCircle, Printer, User, Info } from 'lucide-react';
...
const CGTCalculator = ({ formatCurrency, hasFeature, isAuthenticated, onShowTrialModal, onShowUpgradeModal }) => {
