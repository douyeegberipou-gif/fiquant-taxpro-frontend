              ...
              <div className="border-l-4 border-l-gray-900 bg-gray-50 rounded-r-lg p-4">
                ...
                <div className="grid grid-cols-3 gap-4 text-sm">
                  ...
                  <div>
                    ...
                    <p className="font-medium text-red-600">{formatCurrency(calculation.annual_tax)}</p>
                  </div>
                  <div>
                    <p className="text-gray-500">Annual Net</p>
                    <p className="font-medium text-emerald-600">{formatCurrency(calculation.annual_net_income)}</p>
                  </div>
                </div>
              </div>
            </div>
