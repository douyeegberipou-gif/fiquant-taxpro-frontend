          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
              ...
              <div className="p-6 rounded-xl transition-all duration-300 hover:shadow-md hover:-translate-y-1"
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-600">Experienced finance professionals & tax partners</div>
                  </div>
                </div>
            ...
            <div className="p-8 rounded-2xl shadow-lg transition-all duration-300 hover:shadow-xl hover:-translate-y-1"
              ...
              <blockquote className="text-lg text-gray-700 mb-6 italic">
                "Fiquant TaxPro has been instrumental in helping our company achieve significant tax savings while ensuring we avoid compliance issues and potential fines. The NTA 2025 compliance gives us complete confidence in every calculation we deliver to clients."
              </blockquote>
              
              <div className="flex items-center justify-between mb-6">
                <div>
                  <div className="font-semibold text-gray-800">Ibiaro Goma</div>
                  <div className="text-gray-600">CEO, Lush Ltd</div>
                </div>
