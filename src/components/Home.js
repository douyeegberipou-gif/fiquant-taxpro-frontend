          ...
          <div className="grid lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <div className="relative rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-200 mt-1 text-sm">Ad-supported, 15 calcs/day</p>
              </div>
              
              <ul className="space-y-3 mb-6 text-sm">
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">All calculators (PAYE, CGT, VAT, CIT)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">15 calculations/day</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Bulk PAYE (10 staff, 3x/month)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Tax Library (with ads)</span>
                </li>
                <li className="flex items-center">
            ...
            <div className="relative rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-400 line-through text-sm">₦14,999/month</p>
                ...
                <p className="text-gray-200 mt-1 text-sm">Unlimited, ad-free</p>
              </div>
              
              <ul className="space-y-3 mb-6 text-sm">
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">All calculators, unlimited</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">PDF export & reports</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">90-day calculation history</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Email support (48hr)</span>
                </li>
              </ul>
              ...
              <button
                ...
                className="w-full mt-3 text-sm text-gray-300 hover:text-white transition-colors"
            ...
            <div className="relative rounded-2xl p-6 transform scale-105 transition-all duration-300 hover:shadow-xl hover:-translate-y-2"
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-400 line-through text-sm">₦29,999/month</p>
                <p className="text-3xl font-bold text-white">
                  ₦{isAnnual ? '18,333' : '19,999'}
                  <span className="text-base font-normal text-gray-200">/month</span>
                </p>
                {isAnnual && (
                  <p className="text-green-400 text-sm">₦219,990/year (2 months free)</p>
                )}
                <p className="text-gray-200 mt-1 text-sm">Full power for teams</p>
              </div>
              
              <ul className="space-y-3 mb-6 text-sm">
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Bulk PAYE (unlimited staff)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">CSV import for bulk processing</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Bulk Payment Processing</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Unlimited calculation history</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Email support (24hr)</span>
                </li>
              </ul>
            ...
            <div className="relative rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-200 mt-1 text-sm">For large organizations</p>
              </div>
              ...
              <ul className="space-y-3 mb-6 text-sm">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">API access & integrations</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Phone support + custom SLA</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
