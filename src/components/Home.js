...
const Home = ({ onNavigateToTab, isAuthenticated, setShowTrialModal, setAuthModalOpen, setShowUpgradeModal, user }) => {
  ...
  const handleStartTrialClick = () => {
    if (isAuthenticated && isAuthenticated()) {
      // User is logged in, show trial modal
          ...
          <div className="grid lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            ...
            <div className="relative rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              ...
              <div className="text-center mb-6">
                ...
                <p className="text-gray-200 mt-1 text-sm">Use for free with ads</p>
              </div>
              ...
              <ul className="space-y-3 mb-6 text-sm">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">CGT calculator (unlimited)</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
            ...
            <div className="relative rounded-2xl p-6 transition-all duration-300 hover:shadow-lg hover:-translate-y-1"
              ...
              <ul className="space-y-3 mb-6 text-sm">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Tax Library access</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
            ...
            <div className="relative rounded-2xl p-6 transform scale-105 transition-all duration-300 hover:shadow-xl hover:-translate-y-2"
              ...
              <ul className="space-y-3 mb-6 text-sm">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">CIT calculator</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
                  <span className="text-white">Bulk Payments Processing</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-green-400 mr-2 flex-shrink-0" />
