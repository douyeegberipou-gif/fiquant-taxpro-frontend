...
import { CheckCircle, XCircle, Loader2, AlertTriangle, Crown } from 'lucide-react';
...
const SubscriptionCallback = () => {
  ...
  const verifyPayment = async () => {
    try {
      ...
      const response = await axios.post(`${API_URL}/api/subscription/verify-payment?reference=${reference}`, {}, {
        ...
        <div className="p-8">
          ...
          {status === 'verifying' && (
            <div className="text-center">
              ...
              <p className="text-emerald-200">Please wait while we confirm your subscription...</p>
            </div>
          )}
          ...
          {status === 'success' && (
            <div className="text-center">
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-amber-400 to-amber-600 rounded-full flex items-center justify-center animate-bounce">
                ...
                <div className="bg-white/10 rounded-xl p-4 mb-6 text-left">
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex justify-between text-gray-300">
                      <span>Plan:</span>
                      <span className="text-emerald-400 font-medium">{subscriptionInfo.plan_name}</span>
                    </div>
                    <div className="flex justify-between text-gray-300">
                      <span>Tier:</span>
                      <span className="text-white capitalize">{subscriptionInfo.tier}</span>
                    </div>
                    <div className="flex justify-between text-gray-300">
