...
const UpgradePrompt = ({ 
  ...
  if (type === 'quota') {
    return (
      ...
      >
        <div 
          className="w-full max-w-md mx-auto my-8 rounded-2xl shadow-xl"
          ...
          <div className="p-6">
            <div className="flex justify-between items-start mb-4">
              ...
              <Button 
                variant="ghost" 
                size="sm" 
                className="h-8 w-8 p-0 text-gray-400 hover:text-white hover:bg-white/10 absolute right-4 top-4"
                onClick={handleClose}
              >
                <X className="h-4 w-4" />
              </Button>
            ...
            <p className="text-sm leading-relaxed text-gray-300 text-center mb-6">
              ...
              <br/><br/>
              <strong className="text-blue-400">Keep the momentum going for just ₦9,999/month</strong> and unlock unlimited runs plus advanced features. Or save big with our <strong className="text-yellow-400">annual plan with 2 months free</strong>!
              <br/><br/>
              <strong className="text-green-400">Not ready to commit yet?</strong> We totally understand! Start your <strong>7-day free trial</strong> and continue your work immediately - no strings attached.
            </p>
  ...
  return (
    ...
    >
      <div 
        className="max-w-2xl w-full rounded-2xl max-h-[85vh] overflow-y-auto"
        onClick={(e) => e.stopPropagation()}
        style={{
          backdropFilter: 'blur(20px)',
          WebkitBackdropFilter: 'blur(20px)',
      ...
      >
        <div className="p-6">
          ...
          <div className="text-center space-y-4 mb-6">
            ...
            <p className="text-gray-300 leading-relaxed text-sm">
              <strong className="text-blue-400">Continue your important work for just ₦9,999/month</strong> - and here's the sweet part: get <strong className="text-green-400">2 months free</strong> when you pay annually!
            </p>
            <p className="text-gray-300 leading-relaxed text-sm">
              <strong className="text-purple-400">Want to test-drive first?</strong> Perfect! Start your <strong className="text-emerald-400">7-day free trial</strong> right now and experience all Premium features with zero commitment.
            </p>
          </div>
          ...
          <div className="flex flex-col space-y-3">
            ...
            <Button variant="ghost" onClick={handleClose} className="text-gray-400 hover:text-white hover:bg-white/10">
              Maybe Later
            </Button>
          </div>
        </div>
