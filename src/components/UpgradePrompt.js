      ...
      >
        <div className="p-6">
          ...
          <div className="text-center space-y-4 mb-6">
            ...
            <p className="text-gray-200 leading-relaxed text-sm">
              <strong className="text-blue-300">Continue your important work for just ₦9,999/month</strong> - and here's the sweet part: get <strong className="text-green-300">2 months free</strong> when you pay annually!
            </p>
            <p className="text-gray-200 leading-relaxed text-sm">
