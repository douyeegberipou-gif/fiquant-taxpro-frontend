...
import { Calculator, Building2, AlertTriangle, Printer, Plus, Trash2, Info } from 'lucide-react';
...
const VATCalculator = ({ formatCurrency, hasFeature, isAuthenticated, onShowTrialModal, onShowUpgradeModal }) => {
