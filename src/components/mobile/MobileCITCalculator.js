...
import { Building2, Calculator, DollarSign, FileText, RotateCcw, ChevronDown, ChevronUp, TrendingUp, TrendingDown, AlertTriangle, Settings, CreditCard, CheckCircle } from 'lucide-react';
    ...
    >
      <div className="p-4 pt-40 space-y-4">
        ...
        <CollapsibleSection
          ...
          glassStyle={glassStyle}
        >
          <div className="p-2 rounded-lg mb-3" style={{ background: 'rgba(239, 68, 68, 0.15)' }}>
            <p className="text-xs text-red-300">These expenses are added back to taxable profit</p>
          </div>
          <div className="space-y-3">
            <div className="grid grid-cols-2 gap-3">
