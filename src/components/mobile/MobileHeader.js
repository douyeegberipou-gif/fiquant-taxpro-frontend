        ...
        <div className="bg-black px-4 py-3">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              />
              <div>
                <span className="font-bold text-lg bg-gradient-to-r from-yellow-400 via-yellow-500 to-yellow-600 bg-clip-text text-transparent">
                  Fiquant
                </span>
                <span className="text-yellow-400 text-xs ml-1">TaxPro</span>
              </div>
            </div>
