        ...
        <div className="mb-8 px-1">
          ...
          <div className="space-y-3">
            ...
            >
              ...
              <ul className="text-xs text-gray-200 space-y-1 mb-3">
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> Single PAYE calculator (unlimited)
                </li>
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> Bulk PAYE (5 staff, 1x/month)
                </li>
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> CGT calculator (unlimited)
                </li>
                <li className="flex items-center">
                  <span className="text-red-400 mr-1">✗</span> No PDF export
                </li>
                <li className="flex items-center">
                  <span className="text-red-400 mr-1">✗</span> No history
                </li>
              </ul>
            ...
            >
              ...
              <ul className="text-xs text-gray-200 space-y-1 mb-3">
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> Bulk PAYE (15 staff, unlimited)
                </li>
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> VAT calculator
                </li>
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> Tax Library access
                </li>
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> Save history & PDF reports
                </li>
                <li className="flex items-center">
            ...
            >
              ...
              <ul className="text-xs text-gray-200 space-y-1 mb-3">
                ...
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> CIT calculator
                </li>
                <li className="flex items-center">
                  <span className="text-green-400 mr-1">✓</span> Bulk Payments Processing
                </li>
                <li className="flex items-center">
