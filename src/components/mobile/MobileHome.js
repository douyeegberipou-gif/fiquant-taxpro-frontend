          ...
          <div className="space-y-3">
            ...
            >
              ...
              <button 
                ...
                className="w-full py-2 px-4 bg-gradient-to-r from-emerald-500 to-emerald-600 text-white rounded-lg text-sm font-medium active:scale-95 transition-transform shadow-lg"
              >
                Subscribe
              </button>
