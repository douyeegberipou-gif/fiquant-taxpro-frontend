...
import { Users, Calculator, DollarSign, PiggyBank, FileText, RotateCcw, ChevronDown, ChevronUp, Building2, Home } from 'lucide-react';
    ...
    try {
      ...
      Object.keys(taxInput).forEach(key => {
        if (['staff_name', 'tin', 'month', 'year', 'state_of_residence', 'tax_authority'].includes(key)) {
          ...
          // Send the NHF contribution value (backend will auto-calc if 0 and nhf_applicable is true)
